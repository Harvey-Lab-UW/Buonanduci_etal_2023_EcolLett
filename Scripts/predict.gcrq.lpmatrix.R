...
# Adapted from function predict.gcrq() in package quantregGrowth

# V. M. R. Muggeo, Additive Quantile regression with automatic smoothness selection: the R
# package quantregGrowth (2021) https:/doi.org/10.13140/RG.2.2.29306.21445 (October 31, 2022).


predict.gcrq.lpmatrix <-
